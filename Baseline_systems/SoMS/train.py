...
def  main():
    ...
    savePath = os.path.join("models","SoM_GRU_42")
    datasetLoader = DatasetLoader()
    datasetLoader.dataset = Datasets().audio_features_egemaps_functionals
    datasetLoader.loadDataset()
    datasetLoader.colomnsSeeked = ["Valance", "Valance_0"]
    ...
    gru_num_layers  = 2
    mlp_hidden_size = 32
    dropOut         = 0.1 # *******************************INCREASED FROM 0.1 to 0.2
	...
	#epochs changed from 500 - original to 75 then back to 50
