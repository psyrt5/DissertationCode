...
folder_lld_features = ['/media/richardt/2134-14F6/Actual_Video/visual_features/']
#['/media/richardt/EXTERNAL/Development_Visual/visual_features/']
#['/media/richardt/EXTERNAL/Train_Audio1/audio_features_mfcc/']#, **************************************************added a 1
                      
                      

folder_functionals  = ['/media/richardt/2134-14F6/Actual_Video/visual_features_functionals/']
#['/media/richardt/EXTERNAL/Development_Visual/visual_features_functionals/']
#['/media/richardt/EXTERNAL/Train_Audio1/audio_features_mfcc_functionals/']#, ************************************************************Added a 1
...
for m in range(0, len(folder_lld_features)):
    ...
    for fn in files:
        print(fn)
        if fn != 'DV_asdfasdfasdfasdf1564.csv':
